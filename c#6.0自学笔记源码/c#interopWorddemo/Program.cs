...
namespace Console_WordSkill_All
{
    class Program
    {
        static void CreateWordDoc()
        {
            ...
            path = Environment.CurrentDirectory + "\\TestWord.doc";
            ...
            //string headerfile = "4.jpg";
            string headerfile = Environment.CurrentDirectory + "\\4.jpg";
            ...
            try
            {
                ...
                app.Visible = true;
                string str = Environment.CurrentDirectory + "\\TestWord.doc";
                object file = str;
            ...
            wordDoc = doc;
            wordDoc.Paragraphs.Last.Range.Text += "写这么多吧,祝你好运";
